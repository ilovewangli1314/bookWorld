 ...
 * @param cb    回调函数返回
 */
cc['createPrefab'] = function (res: string, cb: Function) {
 ...
 * 节点上是否存在某些组件
 */
cc.Node.prototype['hasComponent'] = function (types: any) {
 ...
 * @returns {*}
 */
cc['getSpriteFrameByAtlas'] = function getFrameByAtlas(atlas: string, key: string) {
 ...
 * 
 */
cc.Component.prototype['loadScene'] = function (name: string, cb: Function) {
